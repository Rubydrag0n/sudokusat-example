...
public:
	...
	int commander_encode(std::vector<int>* numbers, int* commander);
...
void solve_sudoku(std::string path, std::string solver, std::ofstream* outputfile = nullptr, bool verbose = false);
